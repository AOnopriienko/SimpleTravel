...
namespace SimpleTravel_WPApp
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            IRepository<Apartment> repository = new ApartmentRepository();
            Apartment ac = new Apartment() { Id = Guid.NewGuid(), TypeId = ApartmentType.Hostel, Name = "New Hotel", Address = "Kiev" };
